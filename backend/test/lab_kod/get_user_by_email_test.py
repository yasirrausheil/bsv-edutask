...
def test_get_user_by_email_valid_email_one_user_exists(): 
    fake_dao = Mock()
...
def test_get_user_by_email_valid_email_multiple_users_exist():
    fake_dao = Mock()
...
def test_get_user_by_email_valid_email_no_user_exists():
    fake_dao = Mock()
...
#invalid test case: invalid email format
def test_get_user_by_email_invalid_email_format():
    fake_dao = Mock()
    controller = UserController(fake_dao)
